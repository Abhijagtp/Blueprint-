...
//       history.pushState(
//         { query: srch_query.trim() },
//         "",
//         `./#search/${srch_query.trim()}`
//       );
...
//     // If using a rich text editor like BalloonEditor, you might want to get the editor data.
//     const bodyContent = document.querySelector("#compose-body").innerHTML;
//     formData.append("body", bodyContent);

//     // Append the file (if one is selected)
//     const fileInput = document.querySelector("#compose-attachment");
//     if (fileInput.files.length > 0) {
//       formData.append("attachment", fileInput.files[0]);
//     }

//     // Send the POST request using fetch; note that we do not set Content-Type manually.
//     fetch("/emails", {
//       method: "POST",
//       body: formData,
//     })
...
//           element.classList.add("row", "my-0", "mx-1", "single-mail");
...
//             let del_forever =
//               mailbox === "trash"
//                 ? `<li class="btn-item del_forever" data-toggle="tooltip" data-placement="bottom" title="Delete forever"><i class="fas fa-trash"></i></li>   `
//                 : "";
...
//               });
//               history.pushState(
//                 { email: email.id, element: element.innerHTML, mail: mailbox },
//                 "",
//                 `#${mailbox}/${email.id}`
//               );
...
//           read.classList.remove("fa-envelope");
//           read.classList.add("fa-envelope-open");
//           $(element.querySelector("#check-email .mark-read")).attr(
//             "data-original-title",
//             "Mark as unread"
//           );
//         }
...
//                               <span class="sing-icon rounded-circle text-white" style="background-color:${calculateColor(email.sender)}">
...
//         // Build attachment HTML if available.
//         let attachmentHTML = "";
//         if (email.attachment) {
//           // If your backend also sent attachment_filename, use it. Otherwise, extract from URL.
//           let filename = email.attachment_filename || email.attachment.split('/').pop();
//           attachmentHTML = `
//             <div class="attachment mt-3 p-2 border rounded">
//               <i class="fas fa-paperclip"></i>
//               <a href="${email.attachment}" target="_blank" download>
//                 ${filename}
//               </a>
//             </div>
//           `;
...
//                   <p class="d-inline-block text-truncate p-0 m-0">
//                     <strong>${sender}</strong>
//                     <span class="detail-small d-none d-lg-inline">
//                       <span>&lt;</span>${email.sender}&gt;
//                     </span>
//                   </p>
//                 </div>
//                 <div class="dropdown">
...
//                 <p class="detail-small d-inline time">
//                   ${$(window).width() <= 768 ? readable_date(email.timestamp) : email.timestamp}
//                 </p>
//               </div>
//               <div class="timestamp-icons pl-2">
//                 <span class="st" data-toggle="tooltip" data-placement="bottom" title="${star_title}" style="cursor:pointer">
//                   <i class="${star_class} fa-star"></i>
//                 </span>
//                 <span data-toggle="tooltip" data-placement="bottom" title="Reply">
//                   <i class="fas fa-reply pl-3 replybtn"></i>
//                 </span>
//               </div>
//             </div>
...
//                 ${email.body}
//               </div>
//               ${attachmentHTML}  <!-- Render attachment here -->
//             </div>
            
//             <div class="row mx-auto reply-btn">
//               <button class="btn btn-light border my-3 mb-4 px-4 replybtn" id="reply">
//                 <i class="fas fa-reply pr-3"></i>Reply
//               </button>
//               <button class="btn btn-light border my-3 mb-4 px-4 ml-3" id="forward">
//                 <i class="fas fa-arrow-right pr-3"></i>Forward
//               </button>
//             </div>
//           </div> 
//         `;

//         // Setup event listeners for the buttons as before.
